...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) throws UnsupportedEncodingException {
        ...
        String mysign = "";
        System.out.println("支付宝退款加密前信息为:"+prestr);
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	mysign = MD5.sign(prestr, AlipayConfig.private_key, AlipayConfig.input_charset);
        }else{
        	mysign=SignUtils.sign(prestr, PayActivityUtil.RSA_PRIVATE);
//        	mysign=URLEncoder.encode(SignUtils.sign(prestr, PayActivityUtil.RSA_PRIVATE),AlipayConfig.input_charset);
        }
        return mysign;
    }
