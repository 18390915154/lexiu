...
public class ConfigUtil {
	 ...
	 * 服务号相关信息
	 */
	 public final static String APPID = "wxb9250b0d30ea0bcf";//服务号的应用号
	 public final static String APP_SECRECT = "";//服务号的应用密码
	 public final static String TOKEN = "weixinCourse";//服务号的配置token
	 public final static String MCH_ID = "1302027201";//商户号
	 public final static String API_KEY = "12345678912345678912345678912345";//API密钥
	 public final static String SIGN_TYPE = "MD5";//签名加密方式
	 public final static String CERT_PATH = "D:/apiclient_cert.p12";//微信支付证书存放路径地址
	 
	 
/*	 C:\Users\wang\Desktop\cert\apiclient_cert.p12
*/	//微信支付统一接口的回调action
