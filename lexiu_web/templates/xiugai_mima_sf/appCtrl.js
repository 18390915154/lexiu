angular.module("myapp")
    .controller("setting_entry_sfCtrl",function($scope, $interval, $state,$ionicPopup){
        ...
        $scope.get = function () {
            ...
            /*$http({
                url: "https://192.168.88.128:8080/lexiu/api/user/sendvcode?phone=" + $scope.user,
                type: "post",
                dataType: "json"
        ...
        $scope.next = function () {
            ...
            if ($scope.code == "" || $scope.code == null || $scope.code.length < 6) {
                ...
                $state.go("setting_entry2_sf", {idcode: $scope.code, user: $scope.user});
            }
