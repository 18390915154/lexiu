angular.module("myapp")
	.controller("id_sfCtrl", function($scope, $document,$stateParams, $ionicModal, $http, $state, $ionicPopup) {
		...
		$scope.submit = function() {
			if(!$scope.nickname || !$scope.people || !$scope.tel || !$scope.id_card || !$scope.work) {
				$ionicPopup.alert({
					title: '提示',
					template: '不能为空',
					okText: '确定'
				...
				$.ajax({
					url: "https://www.lerlex.com/lexiu/api/worker/workerPerfect",
					type: "post",
					data: form,
					processData: false,
					contentType: false,
